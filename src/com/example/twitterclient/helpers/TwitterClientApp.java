...
import com.example.twitterclient.activities.TweetsActivity;
...
public class TwitterClientApp extends com.activeandroid.app.Application {
	...
	public static void composeTweet(final Context context, final Long refTweet,
			final int action, final int requestCode) {
		composeTweet(context, refTweet, null, action, requestCode);
	}

	public static void composeTweet(final Context context, final Long refTweet,
			final String screenname, final int action, final int requestCode) {
	...
	public static void showTweets(final Context context, final long userId,
			String query) {
	...
	public static void showRelatedUsers(final Context context,
			final Long userId, final RelatedUserType relatedUserType) {
